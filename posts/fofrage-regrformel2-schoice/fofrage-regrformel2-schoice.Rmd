...
```{r echo=FALSE}
coefs <- data.frame(
  Modell = c("m1", "m2", "m3", "m4"),
  Median = c(coef(m1)[1],coef(m2)[1],coef(m3)[1],coef(m4)[1]),
  CI_low = c(eti(m1)$CI_low[1],eti(m2)$CI_low[1],eti(m3)$CI_low[1],eti(m4)$CI_low[1]),
  CI_high = c(eti(m1)$CI_high[1],eti(m2)$CI_high[1],eti(m3)$CI_high[1],eti(m4)$CI_high[1])
  )
...
Answerlist
----------
* `m3`: `body_mass_g ~ sex + bill_length_mm + sex:bill_length_mm`
* `m1`: `body_mass_g ~ sex`
* `m2`: `body_mass_g ~ sex + bill_length_mm`
* `m4`: `body_mass_g ~ sex:bill_length_mm`
* `m5`: `bill_length_mm ~ sex + body_mass_g + sex:body_mass_g`

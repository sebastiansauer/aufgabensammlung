...
```{r baumdiagramm, echo=FALSE, fig.width=6.5, fig.height=4, fig.cap="", echo=FALSE}
N <- 1000
...
Die Distraktoren entstehen durch typische Bayes-Fehler: Verwechslung mit der Likelihood $Pr(t|g)=0.9$ (Base-Rate-Neglect), 
